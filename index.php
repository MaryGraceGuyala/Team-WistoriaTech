                ...
                <div class="row gy-4 gy-md-0">
                    ...
                    <div class="col-md-6 text-center text-md-start d-flex d-sm-flex d-md-flex justify-content-center align-items-center justify-content-md-start align-items-md-center justify-content-xl-center">
                        <div class="text-center" style="max-width: 350px;">
                            ...
                            <div><a class="btn btn-primary btn-lg me-2" role="button" href="#" data-bs-toggle="modal" data-bs-target="#membership-form" style="background: rgb(19,77,70);">Be our Member</a></div>
                        </div>
                    </div>
                </div>
            </div>
