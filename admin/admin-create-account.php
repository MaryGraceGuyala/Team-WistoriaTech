            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card" style="background: rgba(255,255,255,0.57);">
                    <div class="card-body text-center" style="border-top-left-radius: 10px;border-top-right-radius: 10px;border-bottom-right-radius: 10px;border-bottom-left-radius: 10px;box-shadow: 0px 0px 7px rgb(135,232,89);background: rgba(10,11,10,0.63);border-style: none;">
                        ...
                        <form method="post" action="admin-create-account.php" style="padding: 12px;">
                            <div class="d-flex input-fields" style="margin-top: 5px;margin-bottom: 5px;">
                                <input class="form-control" type="text" id="first_name" name="first_name" placeholder="First Name" required style="border-top-left-radius: 0px;border-bottom-left-radius: 0px;border-style: solid;">
                            </div>
                            <div class="d-flex input-fields" style="margin-top: 5px;margin-bottom: 5px;">
                                <input class="form-control" type="text" id="last_name" name="last_name" placeholder="Last Name" required style="border-top-left-radius: 0px;border-bottom-left-radius: 0px;border-style: solid;">
                            </div>
                            <div class="d-flex input-fields" style="margin-top: 5px;margin-bottom: 5px;">
                            ...
                            <div class="d-flex input-fields" style="margin-top: 5px;margin-bottom: 5px;">
                                <input class="form-control" type="password" id="password" name="password" placeholder="Create Password" required style="border-top-left-radius: 0px;border-bottom-left-radius: 0px;">
                            </div>
                            <div class="d-flex input-fields" style="margin-top: 5px;margin-bottom: 5px;">
                                <input class="form-control" type="password" id="password" name="password" placeholder="Confirm Password" required style="border-top-left-radius: 0px;border-bottom-left-radius: 0px;">
                            </div>
                            ...
                            <div>
                                ...
                                <a class="signup-nav" href="admin-login.php">LOGIN&nbsp;</a></div>
                        </form>
                    </div>
                </div>
            </div>
